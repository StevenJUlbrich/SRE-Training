...
## 🎯 Objective
Given:
- V1 (Foundational draft on process management and system monitoring)
...
## 🚩 Invocation
"Generate a comprehensive Linux SRE training module for Day 6: Processes & System Monitoring following v15.1 guidelines. Create detailed command breakdowns for ps, top, htop, kill, jobs, bg, fg, uname, df, du, free with realistic examples and SRE-focused scenarios. Ensure each command example follows the exact tiered format specified. Verify all content is technically accurate and meets numerical requirements before submission."
