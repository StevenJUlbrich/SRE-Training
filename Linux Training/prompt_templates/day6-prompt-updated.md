...
## 🚩 Invocation
"Generate a comprehensive Linux SRE training module for Day 6: Processes & System Monitoring following v15 guidelines. Create detailed command breakdowns for ps, top, htop, kill, jobs, bg, fg, uname, df, du, free with realistic examples and SRE-focused scenarios. Verify all content is technically accurate and meets numerical requirements before submission."
