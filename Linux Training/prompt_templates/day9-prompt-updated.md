...
## 🚩 Invocation
"Generate a comprehensive Linux SRE training module for Day 9: Archiving & Compression following v15 guidelines. Create detailed command breakdowns for tar, gzip/gunzip, zip/unzip, apt, yum/dnf with realistic examples and SRE-focused scenarios. Verify all content is technically accurate and meets numerical requirements before submission."