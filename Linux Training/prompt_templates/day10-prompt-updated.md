...
## 🎯 Objective
Given:
- V1 (Foundational draft on Linux Shell Scripting Basics & Advanced Concepts. it includes detailed breakdowns for variables, command substitution, loops, conditionals, and environment variables)
...
## 🚩 Invocation
"Generate a comprehensive Linux SRE training module for Day 10: Shell Scripting Basics & Advanced Concepts following v15 guidelines. Create detailed breakdowns for variables, command substitution, loops, conditionals, and environment variables with realistic examples and SRE-focused scenarios. Verify all content is technically accurate and meets numerical requirements before submission."