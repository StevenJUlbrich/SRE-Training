...
2. **Topic Definition Prompt**:
   ```
   Based on the framework in the documents provided, I'd like to develop SRE training materials on Traces and Distributed Tracing for banking professionals transitioning from production support roles. 
   ...
   1. The scope and boundaries of Traces and Distributed Tracing
...
3. **High-Level Outline Prompt**:
   ...
   Please create a chapter outline for our SRE training on Traces and Distributed Tracing that:
...
4. **Audience Analysis Prompt**:
   ...
   Please identify:
   1. Knowledge gaps that production support professionals likely have about Traces and Distributed Tracing
...
5. **Domain Adaptation Prompt**:
   ...
   Please suggest:
   1. Banking-specific or Fintech examples for each chapter
   2. Industry regulations or compliance factors relevant to Traces and Distributed Tracing
   3. Banking systems where these concepts are particularly important
   4. How to connect Traces and Distributed Tracing to banking business metrics and outcomes
   ```
...
6. **Focus Distribution Prompt**:
   ...
   1. How we'll maintain the 80% focus on core SRE Traces and Distributed Tracing concepts
