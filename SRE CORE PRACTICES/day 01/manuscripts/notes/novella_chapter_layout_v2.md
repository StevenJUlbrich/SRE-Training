# Observability 101+ Curriculum Structure (Led by Hector Alvarez)

This is a Hector-led narrative training track focused entirely on **Observability** for production support professionals, especially those transitioning from tools like **ITRS Geneos** into modern SRE practice. The content is dramatically grounded, brutally practical, and always tied to **real banking system impact**.
...
7. **Lesson Locked In** – Wanjiru says, "So… green doesn't mean good." Hector: "Green means the system's lying. Now let's teach it to confess." 
...
After the incident, Hector asks the team to identify specific observability improvements needed:
...
6. **Hector Steps In** – "Observability isn't magic. It's preparation. And you didn't prepare." He slams a diagram down. 
...
9. **Closing Shot** – Hector sipping coffee: "The system didn't hide the truth. You just didn't teach it how to talk." 
...
After this incident, Hector introduces the concept of an "Observability Contract"—a formal agreement between teams about what telemetry will be maintained:
...
8. **Lesson Locked In** – Hector's dry monologue over the scene: "Logs are your system's mouth. Metrics are its mood. Don't confuse ranting with reasoning." 
...
4. **Burn Rate Awakening** – Hector enters with a diagram showing error budget burn across services. "You don't alert on thresholds. You alert on *threats.*" 
...
7. **Lesson Locked In** – Hector's monologue: "Bad alerts make good engineers quit. Let's not build alarms. Let's build clarity." 
...
Throughout his career in banking technology, Hector has identified five recurring patterns that consistently contribute to outages, delayed resolutions, and regulatory issues. By recognizing and addressing these anti-patterns, teams can dramatically improve their observability practices.
...
7. **Sin #4: Uptime Without User Success** – Split screen shows 100% uptime for ATM service but customers unable to withdraw cash. "Congratulations, your metrics are perfect. Too bad they're measuring the wrong thing." 
   ...
   *Expanded narrative: Aisha displays a troubling comparison on the main screen. On the left: service uptime graphs showing 100% availability for the ATM processing service. On the right: successful transaction rate showing near-zero completions. "Your metrics say everything's perfect," she notes. "Meanwhile, not a single customer can withdraw cash." Hector nods grimly. "Congratulations, your metrics are perfect. Too bad they're measuring the wrong thing. Uptime without user success is just efficiently failing."*

8. **Sin #5: "It's Always the Network" Syndrome** – Njeri presents historical data showing 90% of "network issues" were actually application problems. "Stop blaming my network for your code." 
...
4. **Metric Hygiene Time** – Hector redraws the metric stack on a whiteboard, replacing them with business KPIs and SLO-aligned graphs. 
...
8. **Lesson Locked In** – Hector: "Metrics are medical charts. If you don't know how to read them, you're just looking at patient doodles." 
...
9. **Epilogue Panel** – Sofia: "We made it less noisy." Hector: "No. You made it *speak.*" 
...
4. **The Ghost Span Appears** – Hector walks in, drops a hand-annotated span diagram. "Your request went here, here, here, and exploded here." 
...
8. **Lesson Locked In** – Hector: "Tracing is the chalk outline. You want to see where the body dropped. Now you can." 
